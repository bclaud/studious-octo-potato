defmodule InstalacaoSolarWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InstalacaoSolarWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InstalacaoSolarWeb.Gettext, "errors", msg, opts)
    end
  end
